...
详细文档：[nodeJs](http://api.nodejs.cn/)
...
-   最后将需要自动生成的`class`或者`fun`文件放到`__test__`文件夹下，目录如图所示
    ![02.png](../../images/node/02.png)

-   执行`jest testNow`第一个自动生成 jest 文件部署就成功拉
